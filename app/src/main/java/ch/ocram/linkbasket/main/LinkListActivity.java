 ...
 * lead to a {@link LinkDetailActivity} representing
...
public class LinkListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View recyclerView = findViewById(R.id.link_list);
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(LinkDetailFragment.ARG_ITEM_ID, holder.mItem.id);
